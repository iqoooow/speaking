...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email || !password) {
      setError('Elektron pochta va parolni to\'ldiring.');
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (res.success) {
        ...
        setError(res.error || 'Hisobga kirishda xatolik yuz berdi. Pochta yoki parolingizni tekshiring.');
      }
    } catch (err: any) {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-[10px] text-brand-gold-base hover:underline font-bold"
                >
